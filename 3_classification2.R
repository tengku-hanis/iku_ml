##=============================================================================##
## Title: Classification model - intermediate1
...
set.seed(123)
param_latin <- grid_space_filling(tree_depth(), min_n(), size = 20, type = "latin_hypercube")
#size determine how many values to pick from the range of parameters

## Grid maximum entropy search ----
set.seed(123)
param_max <- grid_space_filling(tree_depth(), min_n(), size = 20, type = "max_entropy")
#size determine how many values to pick from the range of parameters
...
## Max entropy search ----
set.seed(123)
param_max <- grid_space_filling(cost_complexity(), tree_depth(), min_n(), size = 100, type = "max_entropy")
